...
public class ClassDecle1 extends ClassDecl {

    private ClassDeclBegin ClassDeclBegin;
    private MultipleMethodDecl MultipleMethodDecl;
    private ClassDeclEnd ClassDeclEnd;

    public ClassDecle1 (ClassDeclBegin ClassDeclBegin, MultipleMethodDecl MultipleMethodDecl, ClassDeclEnd ClassDeclEnd) {
