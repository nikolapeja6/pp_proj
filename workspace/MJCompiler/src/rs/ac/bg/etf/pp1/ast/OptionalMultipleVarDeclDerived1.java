...
public class OptionalMultipleVarDeclDerived1 extends OptionalMultipleVarDecl {

    private MultipleVarDecl MultipleVarDecl;

    public OptionalMultipleVarDeclDerived1 (MultipleVarDecl MultipleVarDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("OptionalMultipleVarDeclDerived1(\n");
