...
public class DesignatorStatementFunctionCallComplex extends DesignatorStatement {

    private MethodDesignator MethodDesignator;
    private ActPars ActPars;

    public DesignatorStatementFunctionCallComplex (MethodDesignator MethodDesignator, ActPars ActPars) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DesignatorStatementFunctionCallComplex(\n");
