...
public class Program2 extends Program {
    ...
    public Program2 (ProgramName ProgramName, MultipleDecl MultipleDecl, ProgramBegin ProgramBegin, MultipleMethodDecl MultipleMethodDecl, ProgramEnd ProgramEnd) {
