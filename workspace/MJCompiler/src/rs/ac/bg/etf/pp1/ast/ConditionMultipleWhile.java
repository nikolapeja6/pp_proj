...
public class ConditionMultipleWhile extends ConditionWhile {

    private CondTerm CondTerm;
    private ConditionList ConditionList;

    public ConditionMultipleWhile (CondTerm CondTerm, ConditionList ConditionList) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ConditionMultipleWhile(\n");
