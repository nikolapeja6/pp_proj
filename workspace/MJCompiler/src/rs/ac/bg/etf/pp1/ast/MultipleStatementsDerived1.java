...
public class MultipleStatementsDerived1 extends MultipleStatements {

    private MultipleStatements MultipleStatements;
    private Statement Statement;

    public MultipleStatementsDerived1 (MultipleStatements MultipleStatements, Statement Statement) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("MultipleStatementsDerived1(\n");
