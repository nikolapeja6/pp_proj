...
public class MethodDeclDerived3 extends MethodDecl {
    ...
    public MethodDeclDerived3 (MethodNameAndRetType MethodNameAndRetType, FormPars FormPars, MethodBegin MethodBegin, MultipleStatements MultipleStatements, MethodEnd MethodEnd) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("MethodDeclDerived3(\n");
